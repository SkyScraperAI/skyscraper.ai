      ...
      >
        ...
        >
          <v-card-title :class="l.color">
            <span
class="white--text title mx-auto" v-text="l.name" />
          </v-card-title>
          <v-card-title>
            <span
class="subheading mx-auto" v-text="l.subtitle" />
          </v-card-title>
          <v-card-text class="grow py-0">
            <v-subheader v-if="idx === 0"
class="px-0">
              Features
            </v-subheader>
            <v-subheader
...
>
          ...
          <v-card-text class="px-3 pb-0">
            <p
class="caption" v-html="l.description" />
          </v-card-text>
          <v-btn
            v-if="l.waitlist"
          ...
          <v-divider />
          <v-card-actions
style="display: block;" class="white px-0 py-0"
>
            <v-list
dense class="transparent pt-0 pb-2"
>
              <v-list-tile
                v-for="(s, i) in specs"
                :key="l.name + s.name"
              ...
              >
                ...
                <v-list-tile-content class="align-end text-xs-right">
                  <span style="margin-left: auto;" v-html="s.values[idx]" />
                </v-list-tile-content>
              </v-list-tile>
            </v-list>
          </v-card-actions>
        ...
        priceLevels: [
          {
            ...
            description:
              "Kilo shares public safety radio and vehicle telemetry to the SkyScraper Network.",
          },
          {
            name: "Mega",
