<template>
  <v-container
dark class="primary lighten-2 pb-5"
id="analyze" fluid
>
    <div
id="building-top-container" style="z-index: 10;"
>
      <img
        id="building-top"
        alt="SkyScraper Drawing"
        src="~/assets/img/skyscraper-top.svg"
      />
    </div>
    <v-container
grid-list-lg px-0
...
>
          ...
          >
            <v-card-title class="red darken-2">
              <h3
class="white--text display-1 mx-auto" v-text="app.name" />
            </v-card-title>
            <v-card-text>
              <p
class="subheading" v-html="app.description" />
              <v-list
v-if="app.list" subheader
dense class="transparent"
>
